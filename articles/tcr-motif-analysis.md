...
This vignette demonstrates how to create sequence motif logos from TCR
CDR3 sequences using the motifStack package. Motif logos visualize
...
For meaningful motif analysis, we need epitopes with multiple TCR
sequences:
...
3.  **Alternative**: Use tools like MUSCLE for multiple sequence
    alignment
...
**High information content positions**: Indicate conserved amino acids
important for epitope recognition

**Variable positions**: May represent: - Degeneracy in TCR binding -
Sampling bias in VDJdb - True diversity in recognition modes

**Central positions**: Often more conserved as they typically contact
peptide-MHC
